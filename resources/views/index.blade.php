...
@section('content')
    ...
    <section class="rev_slider_wrapper">
        <div class="rev_slider materialize-slider">
            <ul>
                <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="{{asset('assets/img/main-banner/chalewote_2017_19.08.‎2017_selected_1.jpg')}}" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off">
                    <img src="{{asset('assets/img/main-banner/chalewote_2017_19.08.‎2017_selected_1.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                ...
                <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="{{asset('assets/img/main-banner/Edited_CLOCK-PHOTOSHOOT_18.07.‎2018-44.jpg')}}" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Unique Design" data-description="">
                    <img src="{{asset('assets/img/main-banner/Edited_CLOCK-PHOTOSHOOT_18.07.‎2018-44.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                </li>
